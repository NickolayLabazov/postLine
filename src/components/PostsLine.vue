<template>
  <div class="postsline-maincontainer">
    ...
    <div class="postsline-buttoncontainer">
      ...
      <b-button type="is-success" size="is-small" v-if="user!==null && user.role=='writer'" v-on:click="handleCreate()">Добавить пост</b-button>
      <b-button type="is-link" size="is-small" v-if="usersSize / (step + 1) > 10" v-on:click="handleForward()">Вперёд</b-button>
    </div>
...
import { FETCH_CLAPS, FETCH_POST_REMOVE, SET_UPDATE, SET_CURRENT_POST_ID, SET_POST_INPUT,
  SET_POST_TEXT, INCREASE_STEP,
  DECREASE_STEP, SET_USERSSIZE, FETCH_POSTS } from "../store/mutations.type";
